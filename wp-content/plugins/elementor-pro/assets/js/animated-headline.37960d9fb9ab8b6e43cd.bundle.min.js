            ...
            var s = n(i(9237)),
                a = elementorModules.frontend.handlers.Base.extend({
                    ...
                    showLetter(e, t, i, n) {
                        ...
                        e.addClass(a.animationIn), e.is(":last-child") ? i || setTimeout((function() {
                            s.hideWord(t)
                    ...
                    hideLetter(e, t, i, n) {
                        var s = this,
                            a = this.getSettings();
                        e.removeClass(a.classes.animationIn), e.is(":last-child") ? i && setTimeout((function() {
                    ...
                    showWord(e, t) {
                        ...
                        "typing" === s ? (i.showLetter(e.find("." + n.classes.dynamicLetter).eq(0), e, !1, t), e.addClass(n.classes.textActive).removeClass(n.classes.textInactive)) : "clip" === s && i.elements.$dynamicWrapper.animate({
                            width: e.width() + 10
                    ...
                    hideWord(e) {
                        ...
                        if (this.isLoopMode || !e.is(":last-child"))
                            if ("typing" === a) t.elements.$dynamicWrapper.addClass(n.typeSelected), setTimeout((function() {
                                t.elements.$dynamicWrapper.removeClass(n.typeSelected), e.addClass(i.classes.textInactive).removeClass(n.textActive).children(s).removeClass(n.animationIn)
                            ...
                            t.hideLetter(e.find(s).eq(0), e, r, i.lettersDelay), t.showLetter(l.find(s).eq(0), l, r, i.lettersDelay), t.setDynamicWrapperWidth(l)
                        } else "clip" === a ? t.elements.$dynamicWrapper.animate({
                            width: "2px"
                        }, i.revealDuration, (function() {
                            t.switchWord(e, l), t.showWord(l)
                        })) : (t.switchWord(e, l), setTimeout((function() {
                            t.hideWord(l)
                        }), i.animationDelay))
                    },
                    ...
                    animateHeadline() {
                        ...
                        "clip" === t ? i.width(i.width() + 10) : "typing" !== t && e.setDynamicWrapperWidth(e.elements.$dynamicText), setTimeout((function() {
                    ...
                    activateHighlightAnimation() {
                        ...
                        i.removeClass(t.hideHighlight).addClass(t.activateHighlight), this.isLoopMode && (setTimeout((() => {
